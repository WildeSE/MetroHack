...
public:
	...
	virtual void Function2();
	virtual CEntityClass* GetClass();
	virtual void Function4();
	virtual void SetFlags(__int32 flags);
	virtual __int32 GetFlags();
	virtual void Function7();
	virtual void Function8();
	virtual void Function9();
	virtual void Function10();
	...
	virtual void Function21();
	virtual void Function22();
	virtual const D3DXMATRIX& GetWorldTM();
	virtual void Function24();
	virtual void Function25();
	virtual void Function26();
	virtual void Function27();
	...
	virtual void Function32();
	virtual void Function33();
	virtual D3DXVECTOR3 GetWorldPos();
};
...
public:
	...
	virtual const char *GetTeamName(int teamId);
	virtual int GetTeamId(const char *name);
	virtual int GetTeamCount();
	virtual int GetTeamPlayerCount(int teamId, bool inGame = false);
	virtual int GetTeamChannelCount(int teamId, bool inGame = false);
	virtual EntityId GetTeamPlayer(int teamId, int idx);
	virtual void Function117(); //GetTeamPlayers(int teamId, TPlayers &players);
	virtual void Function118(); //
	virtual void SetTeam(int teamId, EntityId entityId);
	virtual int  GetChannelTeam(int channelId);
	virtual int GetTeam(EntityId entityId);
};
