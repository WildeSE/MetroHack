...
char *Sett = "Multiplays.org, Пользовательские настройки";
char *Patch = GetFile("C:\multiplaysOrg_setting.dat");
...
#define Message(text,head) MessageBox(NULL, text, head, MB_OK);
